...
void doc_generate(compiler_t* compiler, const char* filename)
{
	...
	fprintf(fp, "\t\t<style>\n.frame,code{white-space:nowrap}body,code,h1,h2,h3,img,p,pre{margin:0;padding:0}body{background:#fff;color:#333;font:16px/25px \"Source Sans Pro\",georgia,serif}.page{margin:0 auto;width:800px}h2,h3{margin:24px 0 0;color:#39c}.page:after{content:"";display:table;clear:both}.main-column,main{position:relative;width:560px}header h1,header h2{position:absolute;padding:0;letter-spacing:2px;color:#9ca0a3}header{text-shadow:0 1px 1px #141a1f;background:#394046;border-bottom:solid 1px #141a1f}header .page{height:120px}header h1{left:0;top:63px;font:400 48px Sanchez,helvetica,arial,sans-serif}header h2{right:0;top:72px;font:500 13px Lato,helvetica,arial,sans-serif;text-transform:uppercase}h1{padding-top:30px;font:500 36px/60px Sanchez,helvetica,arial,sans-serif;color:#39c}h2{font:500 24px Sanchez,helvetica,arial,sans-serif}h3{font:20px \"Source Sans Pro\",georgia,serif}a{color:#39c;text-decoration:none;transition:color .2s,text-shadow .2s;outline:0}main{padding-top:12px;float:left}li,p{margin:10px 0}p+p{margin-top:20px}code,pre{color:#52667a;font:13px \"Source Code Pro\",Menlo,Monaco,Consolas,monospace;background:#f9fafb;border-radius:2px;border:2px solid #f0f3f5;border-bottom:solid 2px #e0e7eb}code{padding:1px 2px}.frame{text-align:center;margin:1em 0;position:relative}img{margin:0 auto;position:absolute;display:block;height:auto!important;width:auto!important;max-width:100%%}pre{margin:10px 0;line-height:20px;padding:10px;overflow:auto}\n\t\t</style>\n");
